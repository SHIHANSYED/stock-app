    ...
    <div className=" bg-violet-400  h-full grid grid-cols-8 grid-rows-6 gap-2  ">
      <div className="col-start-2 col-end-8 row-start-1 row-end-7 h-full w-full rounded-lg   ">
        <div className="mt-3 text-black  flex justify-around px-3 font-mono font-bold bg-white rounded-lg my-2 border border-primary">
          <button
            className={`px-4 p-2 rounded focus:outline-none ${
              isSelectedFirst ? "bg-gray-900 text-white rounded-m " : ""
            }`}
            onClick={handleFirstButtonClick}
          >
            {isSelectedFirst ? " ⚪ Main Market" : "Main Market"}
          </button>
          ...
          >
            {isSelectedSecond ? " ⚪ Junior Market" : "Junior Market"}
          </button>
          <button
            className={`px-4 py-2 rounded focus:outline-none ${
          ...
          >
            {isSelectedThird ? " ⚪ FX Rates" : "FX Rates"}
          </button>
          <button
            className={`px-4 py-2 rounded focus:outline-none ${
          ...
          >
            {isSelectedFourth ? " ⚪ Crypto" : " Crypto"}
          </button>
        </div>
      </div>
